...
class IndexView(tables.DataTableView):
    ...
    def get_data(self):
        ...
        thread_get_flavors = threading.Thread(target=_task_get_flavors)
        thread_get_images = threading.Thread(target=_task_get_images)

        thread_get_instances.start()
        thread_get_flavors.start()
        thread_get_images.start()

        thread_get_instances.join()
        thread_get_flavors.join()
        thread_get_images.join()
