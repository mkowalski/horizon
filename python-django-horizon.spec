...
Source0:    python-django-horizon-%{version}.tar.gz
...
%prep
%autosetup -n python-django-horizon-%{version} -S git

# drop config snippet
cp -p configfiles/openstack-dashboard-httpd-logging.conf .
...
install -m 0644 -D -p configfiles/openstack-dashboard-httpd-2.4.conf %{buildroot}%{_sysconfdir}/httpd/conf.d/openstack-dashboard.conf
...
cp configfiles/python-django-horizon-systemd.conf %{buildroot}%{_unitdir}/httpd.service.d/openstack-dashboard.conf
...
cp -a configfiles/python-django-horizon-logrotate.conf %{buildroot}%{_sysconfdir}/logrotate.d/openstack-dashboard
