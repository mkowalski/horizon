...
horizon.Quota = {
  ...
  showTypeDetails: function(scope) {
    ...
    if (scope.selected_type) {
      ...
      $("#type_name").text(scope.selected_type.name);
      $("#type_usage").text(scope.selected_type.usage);
      $("#type_hypervisor").text(scope.selected_type.hypervisor);
      $("#type_iops").text(scope.selected_type.iops);
      $("#type_throughput").text(scope.selected_type.throughput);
      // update data from quotas
